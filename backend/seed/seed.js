...
// These imageUrl values point to the /uploads/ static folder on your server.
// To use real local images instead of Unsplash URLs:
//
// 1. Download food images and rename them exactly as below:
//    - carbonara.jpg
//    - tikka.jpg
//    - lavacake.jpg
//    - tacos.jpg
...
//    - risotto.jpg
//
// 2. Place all images into:  backend/uploads/
//
// 3. Change each imageUrl below from the Unsplash URL to:
//    http://localhost:5001/uploads/carbonara.jpg   (etc.)
//
  ...
  const recipes = [
    {
      ...
      category: 'Italian',
      cookingTime: 30,
      // To use a local image: 'http://localhost:5001/uploads/carbonara.jpg'
      imageUrl: 'http://localhost:5001/uploads/Classic_Spaghetti_Carbonara.jpg',
    ...
    },
    {
      ...
      category: 'Indian',
      cookingTime: 50,
      imageUrl: 'http://localhost:5001/uploads/Chicken_Tikka_Masala.jpg',
    ...
    },
    {
      ...
      category: 'Desserts',
      cookingTime: 25,
      imageUrl: 'http://localhost:5001/uploads/Chocolate_Lava_Cake.jpg',
    ...
    },
    {
      ...
      category: 'Mexican',
      cookingTime: 20,
      imageUrl: 'http://localhost:5001/uploads/Beef_Tacos.jpg',
    ...
    },
    {
      ...
      category: 'Asian',
      cookingTime: 25,
      imageUrl: 'http://localhost:5001/uploads/Pad_Thai.jpg',
    ...
    },
    {
      ...
      cookingTime: 10,
      imageUrl: 'http://localhost:5001/uploads/Greek_Salad.jpg',
    ...
    },
    {
      ...
      category: 'American',
      cookingTime: 20,
      imageUrl: 'http://localhost:5001/uploads/Buttermilk_Pancakes.jpg',
    ...
    },
    {
      ...
      category: 'Italian',
      cookingTime: 40,
      imageUrl: 'http://localhost:5001/uploads/Mushroom_Risotto.jpg',
